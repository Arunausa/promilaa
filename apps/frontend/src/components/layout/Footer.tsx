      ...
      <div className="container mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 pt-2 text-slate-400">
            {/* Facebook SVG */}
            <a href="https://facebook.com/promilaabd" target="_blank" rel="noopener noreferrer" aria-label="Follow Promilaa on Facebook" className="w-8 h-8 rounded-full bg-slate-900 hover:bg-amber-600 hover:text-white flex items-center justify-center transition-colors">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            {/* Instagram SVG */}
            <a href="https://instagram.com/promilaabd" target="_blank" rel="noopener noreferrer" aria-label="Follow Promilaa on Instagram" className="w-8 h-8 rounded-full bg-slate-900 hover:bg-amber-600 hover:text-white flex items-center justify-center transition-colors">
            ...
            {/* Youtube SVG */}
            <a href="https://youtube.com/@promilaabd" target="_blank" rel="noopener noreferrer" aria-label="Subscribe to Promilaa on YouTube" className="w-8 h-8 rounded-full bg-slate-900 hover:bg-amber-600 hover:text-white flex items-center justify-center transition-colors">
